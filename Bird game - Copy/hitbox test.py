...
while running:
    ...
    print(f"Current Coordinates: x = {bird.rect.x}, y = {bird.rect.y}")
    ...
    bird_rect = pygame.Rect(bird.rect.x, bird.rect.y, bird_width // 6, bird_height)  # Set the hitbox size to 1/6th of the original width
    for obstacle in obstacles:
    ...
    pygame.draw.rect(screen, (255, 0, 0), bird_rect, 2)  # Draw a red rectangle around the bird's hitbox
    # Display score
